        ...
        <main className="min-h-screen bg-black text-white selection:bg-yellow-500 selection:text-black font-sans overflow-x-hidden">
            ...
            <nav className="fixed top-0 w-full z-50 bg-black/50 backdrop-blur-md border-b border-white/10">
                <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
                    <span className="font-bold text-xl tracking-tighter uppercase">Constrictor<span className="text-yellow-500">Team</span></span>
                    <a
                        href="https://chat.whatsapp.com/CIlQtxdzx7nDjxMqmci8ki"
                        target="_blank"
                        className="text-xs font-bold uppercase tracking-widest bg-white/10 hover:bg-white/20 px-4 py-2 rounded-full transition-colors"
                    >
                        Vagas Limitadas
                    </a>
                </div>
